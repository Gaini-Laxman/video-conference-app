    ...
    <div className="home-container">
      <div className="video-container">
        <video
          ...
          autoPlay
          muted
          style={{ visibility: videoOn ? "visible" : "hidden" }}
        />
      ...
      <div className="action-group">
        ...
        {spinner && (
          <div className="spinner">
            <MoonLoader color="#004dfd" size={32} />
          </div>
        )}
      </div>
    </div>
...
export const VoiceDetector = ({
  ...
  return (
    <div
      ...
      style={{ gap: gap ?? "" }}
    >
      {new Array(count ?? 3).fill(1).map((_, index) => (
        <i
          key={index}
          style={{ color: color ?? "", animationDelay: `${index * 0.2}s` }}
        ></i>
      ))}
    </div>
  );
